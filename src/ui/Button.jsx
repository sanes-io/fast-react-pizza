...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    secondary: `${base} border-2 border-stone-300 text-stone-400 px-4 py-3 md:px-6 md:py-3.5 bg-transparent hover:bg-stone-3 focus:bg-stone-300 hover:text-stone-800 focus:ring-stone-200 focus:text-stone-800`,
